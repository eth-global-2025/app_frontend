...
export const Home = () => {
  ...
  const { allUserThesis } = useUserThesis();
        ...
        <div className="mb-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Discover, purchase, and access cutting-edge research from leading academics worldwide
            </p>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {allThesis.map((thesis, index) => (
                  <ThesisCard
                    ...
                    purchasedThesisCids={allUserThesis.map(t => t.cid)}
